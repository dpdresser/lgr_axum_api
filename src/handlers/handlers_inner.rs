...
pub async fn create_question(
    ...
    match question {
        ...
        Err(err) => {
            error!("Error creating question: {}", err.to_string());
...
pub async fn read_questions(
    ...
    match questions {
        ...
        Err(err) => {
            error!("Error retrieving questions: {}", err.to_string());
            Err(HandlerError::default_internal_error())
        }
    }
}
...
pub async fn create_answer(
    ...
    match answer {
        Ok(answer) => Ok(answer),
        Err(err) => {
            error!("Error creating answer: {}", err.to_string());
...
pub async fn read_answers(
    ...
    match answers {
        ...
        Err(err) => {
            error!("Error retrieving question answers: {}", err.to_string());
            Err(HandlerError::default_internal_error())
        }
    }
}
